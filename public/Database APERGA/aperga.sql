...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 18 Jun 2023 pada 19.48
...
--
-- Struktur dari tabel `info_payments`
--

CREATE TABLE `info_payments` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kanal_pembayaran` varchar(255) NOT NULL,
  `tipe_pembayaran` varchar(255) NOT NULL,
  `nomor_pembayaran` varchar(255) NOT NULL,
  `nama_pemilik` varchar(255) NOT NULL,
  `instruksi_pembayaran` text NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data untuk tabel `info_payments`
--

INSERT INTO `info_payments` (`id`, `kanal_pembayaran`, `tipe_pembayaran`, `nomor_pembayaran`, `nama_pemilik`, `instruksi_pembayaran`, `created_at`, `updated_at`) VALUES
(1, 'Bank', 'BCA', '1234567890', 'PT Adi Perkasa Guna', '1. Kunjungi bank atau buka aplikasi perbankan online Anda.\n<br>\n2. Pilih menu Transfer.\n<br>\n3. Masukkan nomor rekening tujuan yaitu  	1234567890.\n<br>\n4. Masukkan jumlah pembayaran yang sesuai dan konfirmasikan bukti transfer anda', NULL, NULL),
(2, 'Bank', 'BNI', '2345678901', 'PT Adi Perkasa Guna', '1. Kunjungi bank atau buka aplikasi perbankan online Anda.\n<br>\n2. Pilih menu Transfer.\n<br>\n3. Masukkan nomor rekening tujuan yaitu 2345678901.\n<br>\n4. Masukkan jumlah pembayaran yang sesuai dan konfirmasikan bukti transfer anda.', NULL, NULL),
(3, 'Bank', 'BRI', '3456789012', 'PT Adi Perkasa Guna', '1. Kunjungi bank atau buka aplikasi perbankan online Anda.\n<br>\n2. Pilih menu Transfer.\n<br>\n3. Masukkan nomor rekening tujuan yaitu 3456789012.\n<br>\n4. Masukkan jumlah pembayaran yang sesuai dan konfirmasikan bukti transfer anda', NULL, NULL),
(4, 'Bank', 'MANDIRI', '4567890123', 'PT Adi Perkasa Guna', '1. Kunjungi bank atau buka aplikasi perbankan online Anda.\n<br>\n2. Pilih menu Transfer.\n<br>\n3. Masukkan nomor rekening tujuan yaitu 4567890123.\n<br>\n4. Masukkan jumlah pembayaran yang sesuai dan konfirmasikan bukti transfer anda', NULL, NULL),
(5, 'Bank', 'BSI SYARIAH', '5678901234', 'PT Adi Perkasa Guna', '1. Kunjungi bank atau buka aplikasi perbankan online Anda.\n<br>\n2. Pilih menu Transfer.\n<br>\n3. Masukkan nomor rekening tujuan yaitu 5678901234.\n<br>\n4. Masukkan jumlah pembayaran yang sesuai dan konfirmasikan bukti transfer anda', NULL, NULL),
(6, 'Ewallet', 'DANA', '08319267121', 'PT Adi Perkasa Guna', '- Buka aplikasi DANA di ponsel Anda. \n<br>\n- Pilih menu Pembayaran pada aplikasi. \n<br>\n- Masukkan nomor pembayaran berikut: 08319267121. \n<br>\n- Masukkan jumlah pembayaran yang sesuai dan konfirmasikan pembayaran', NULL, NULL),
(7, 'Ewallet', 'OVO', '08772021243', 'PT Adi Perkasa Guna', '- Buka aplikasi OVO di ponsel Anda. \n<br>\n- Pilih menu Pembayaran pada aplikasi. \n<br>\n- Masukkan nomor pembayaran berikut: 08772021243. \n<br>\n- Masukkan jumlah pembayaran yang sesuai dan konfirmasikan pembayaran', NULL, NULL),
(8, 'Ewallet', 'GOPAY', '08971200876', 'PT Adi Perkasa Guna', '- Buka aplikasi GOPAY di ponsel Anda. \n<br>\n- Pilih menu Pembayaran pada aplikasi. \n<br>\n- Masukkan nomor pembayaran berikut: 08971200876. \n<br>\n- Masukkan jumlah pembayaran yang sesuai dan konfirmasikan pembayaran', NULL, NULL);
...
(18, '2023_06_10_060209_create_transaksi_saldos_table', 14);
...
CREATE TABLE `order_transactions` (
  ...
  `prt_id` bigint(20) UNSIGNED DEFAULT NULL,
  `tipe_pembayaran` varchar(255) DEFAULT NULL,
  `total_harga` bigint(100) DEFAULT NULL,
...
INSERT INTO `order_transactions` (`id`, `user_id`, `prt_id`, `tipe_pembayaran`, `total_harga`, `tanggal_transaksi`, `jam_kerja`, `durasi_kerja`, `catatan_khusus`, `status_transaksi`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL, '2023-06-17', '12', '2', NULL, 'Transaksi Dibatalkan', '2023-06-17 06:47:48', '2023-06-17 06:48:39'),
(2, 1, 1, NULL, NULL, '2023-06-17', '12', '2', NULL, 'Memilih Pembayaran', '2023-06-17 06:49:13', '2023-06-17 06:49:13'),
(3, 1, 1, 'SALDO APERGA', 5355000, '2023-06-17', '12', '1', NULL, 'Pembayaran Selesai', '2023-06-17 06:50:59', '2023-06-17 06:51:18'),
(4, 1, 3, 'QRIS', 10290000, '2023-06-17', '12', '2', NULL, 'Pembayaran Selesai', '2023-06-17 06:51:52', '2023-06-17 06:53:41'),
(5, 2, 1, 'QRIS', 10710000, '2023-06-17', '12', '2', NULL, 'Pembayaran Selesai', '2023-06-17 07:13:56', '2023-06-17 07:15:43');
...
(1, 0, 'Eva Nurhayati', 5100000, 29, '4.9', 'Jakarta', 0, 0, '', 'Pengalaman 6 tahun sebagai pekerja rumah tangga. Ahli dalam merapikan rumah, mencuci pakaian, dan menjaga kebersihan lingkungan.', '0898901234', '2023-05-24 18:04:07', '2023-06-17 07:19:22'),
...
(3, 1, 'Gita Permata', 4900000, 30, '4.8', 'Yogyakarta', 2, 12, '', 'Dalam 3 tahun terakhir, saya telah menjadi pekerja rumah tangga yang terampil dalam mengatur jadwal kegiatan rumah tangga, menjaga kebersihan, serta memberikan perhatian kepada anggota keluarga.', '0812345678', '2023-05-24 18:04:07', '2023-06-17 06:53:41'),
...
(5, 0, 'Indah Sari', 4700000, 26, '4.0', 'Jakarta', 1500, 12, '', 'Saya adalah pekerja rumah tangga berpengalaman selama 7 tahun. Saya terampil dalam membersihkan rumah, mencuci pakaian, dan merawat anak-anak.', '0834567890', '2023-05-24 18:04:07', '2023-06-11 10:32:12'),
(6, 0, 'Joko Prabowo', 5100000, 32, '4.2', 'Bandung', 0, 0, NULL, 'Pekerja rumah tangga dengan pengalaman 4 tahun. Saya ahli dalam membersihkan rumah, merapikan pakaian, dan menyiapkan makanan.', '0845678901', '2023-05-24 18:04:07', '2023-06-07 08:30:26'),
(7, 0, 'Kartika Dewi', 4500000, 27, '4.0', 'Yogyakarta', 1, 12, '', 'Saya telah bekerja sebagai pekerja rumah tangga selama 5 tahun. Selama periode tersebut, saya telah melaksanakan berbagai tugas, termasuk membersihkan rumah, mencuci pakaian, menyiapkan makanan, dan merawat anak-anak.', '0890123456', '2023-05-24 18:04:07', '2023-06-16 08:57:03'),
...
(9, 0, 'Maulana Yusuf', 5300000, 28, '4.2', 'Jakarta', 0, 0, '', 'Pekerja rumah tangga selama 4 tahun, menjalankan tugas-tugas rumah tangga dengan baik, seperti membersihkan rumah, mencuci pakaian, dan merawat anak-anak dengan penuh perhatian.', '0892345678', '2023-05-24 18:04:07', '2023-06-12 23:58:38'),
...
(11, 0, 'Oscar Prasetyo', 5100000, 29, '3.7', 'Yogyakarta', 12, 12, '', 'Pengalaman 3 tahun sebagai pekerja rumah tangga. Saya ahli dalam merapikan rumah, mencuci pakaian, dan menjaga kebersihan lingkungan rumah.', '0894567890', '2023-05-24 18:04:07', '2023-06-11 11:45:24'),
...
(14, 0, 'Rini Utami', 5300000, 31, '4.4', 'Bandung', 12, 12, '', 'Pengalaman 6 tahun sebagai pekerja rumah tangga. Saya mampu melakukan berbagai tugas rumah tangga dengan teliti dan bertanggung jawab.', '0897890123', '2023-05-24 18:04:07', '2023-06-12 01:27:05'),
...
(16, 0, 'Vita Agustina', 5000000, 25, '4.0', 'Jakarta', 0, 0, '', 'Pekerja rumah tangga dengan pengalaman 4 tahun. Saya ahli dalam membersihkan rumah, merapikan pakaian, dan menyiapkan makanan.', '0812345678', '2023-05-24 18:17:42', '2023-06-09 09:36:42'),
(17, 0, 'Michael Jordan', 4500000, 30, '4.8', 'Surabaya', 12, 12, '', 'Saya telah bekerja sebagai pekerja rumah tangga selama 5 tahun. Selama periode tersebut, saya telah melaksanakan berbagai tugas, termasuk membersihkan rumah, mencuci pakaian, menyiapkan makanan, dan merawat anak-anak.', '0823456789', '2023-05-24 18:17:42', '2023-06-12 03:57:26'),
...
(19, 0, 'Kusnanto Purwoto', 4800000, 32, '3.9', 'Yogyakarta', 0, 0, '', 'Pekerja rumah tangga selama 4 tahun, menjalankan tugas-tugas rumah tangga dengan baik, seperti membersihkan rumah, mencuci pakaian, dan merawat anak-anak dengan penuh perhatian.', '0845678901', '2023-05-24 18:17:42', '2023-06-10 06:50:01'),
(20, 0, 'Gempita Sari', 5200000, 27, '3.7', 'Medan', 12, 12, '', 'Saya adalah pekerja rumah tangga yang berpengalaman selama 5 tahun. Saya terampil dalam membersihkan, mencuci, dan merawat anak-anak dengan penuh perhatian.', '0890123456', '2023-05-24 18:17:42', '2023-06-11 04:18:42'),
(21, 0, 'Fajar Wijaya', 4600000, 31, '4.7', 'Surabaya', 0, 0, '', 'Pengalaman 3 tahun sebagai pekerja rumah tangga. Saya ahli dalam merapikan rumah, mencuci pakaian, dan menjaga kebersihan lingkungan rumah.', '0812345678', '2023-05-24 18:17:42', '2023-06-09 10:09:03'),
...
(23, 0, 'Radhika Putri', 5100000, 26, '4.2', 'Bandung', 12, 12, '', 'Dalam 3 tahun terakhir, saya telah menjadi pekerja rumah tangga yang terampil dalam mengatur jadwal kegiatan rumah tangga, menjaga kebersihan, serta memberikan perhatian kepada anggota keluarga.', '0834567890', '2023-05-24 18:17:42', '2023-06-12 01:24:47'),
(24, 0, 'Indra Perdana', 4700000, 33, '3.5', 'Yogyakarta', 12, 12, '', 'Pengalaman 6 tahun sebagai pekerja rumah tangga. Saya mampu melakukan berbagai tugas rumah tangga dengan teliti dan bertanggung jawab.', '0845678901', '2023-05-24 18:17:42', '2023-06-12 00:03:53'),
...
(28, 0, 'Maman Hidayat', 5200000, 31, '3.7', 'Bandung', 2412, 36, 'oke gesoke ges', 'Dalam 3 tahun terakhir, saya telah menjadi pekerja rumah tangga yang ahli dalam merapikan rumah, mencuci dan melipat pakaian, serta merawat anak-anak dengan penuh perhatian.', '0834567890', '2023-05-24 18:17:42', '2023-06-12 01:25:26'),
(29, 0, 'Nadia Putri', 5000000, 29, '4.8', 'Yogyakarta', 26, 24, 'sangat mantap', 'Pekerja rumah tangga selama 4 tahun, menjalankan tugas-tugas rumah tangga dengan baik, seperti membersihkan rumah, mencuci pakaian, dan merawat anak-anak dengan penuh perhatian.', '0845678901', '2023-05-24 18:17:42', '2023-06-11 04:55:44'),
...
(32, 0, 'Rudi Hartono', 4700000, 27, '3.5', 'Jakarta', 0, 0, '', 'Saya telah bekerja sebagai pekerja rumah tangga selama 4 tahun. Saya menjalankan tugas-tugas rumah tangga dengan baik, seperti membersihkan rumah, mencuci pakaian, dan merawat anak-anak dengan penuh perhatian.', '0823456789', '2023-05-24 18:17:42', '2023-06-09 10:10:19'),
...
(43, 0, 'Denny Pratama', 5000000, 29, '4.8', 'Bandung', 12, 12, '', 'Dalam 3 tahun terakhir, saya telah menjadi pekerja rumah tangga yang terampil dalam mengatur jadwal kegiatan rumah tangga, menjaga kebersihan, serta memberikan perhatian kepada anggota keluarga.', '0834567890', '2023-05-24 18:17:42', '2023-06-12 23:57:32'),
...
(45, 0, 'Fandi Susanto', 5100000, 33, '3.9', 'Medan', 1200, 12, '', 'Saya adalah pekerja rumah tangga berpengalaman selama 7 tahun. Saya terampil dalam membersihkan rumah, mencuci pakaian, dan merawat anak-anak.', '0890123456', '2023-05-24 18:17:42', '2023-06-14 06:08:14'),
...
(47, 0, 'Hendro Wibowo', 5300000, 30, '4.4', 'Jakarta', 24, 24, '', 'Saya telah bekerja sebagai pekerja rumah tangga selama 5 tahun. Selama periode tersebut, saya telah melaksanakan berbagai tugas, termasuk membersihkan rumah, mencuci pakaian, menyiapkan makanan, dan merawat anak-anak.', '0823456789', '2023-05-24 18:17:42', '2023-06-14 06:11:17'),
...
(77, 0, 'Nadia Rahayu', 5300000, 30, '3.7', 'Jakarta', 0, 0, '', 'Saya telah bekerja sebagai pekerja rumah tangga selama 5 tahun. Selama periode tersebut, saya telah melaksanakan berbagai tugas, termasuk membersihkan rumah, mencuci pakaian, menyiapkan makanan, dan merawat anak-anak.', '0823456789', '2023-05-24 18:17:42', '2023-06-10 06:50:39'),
...
(155, 0, 'Dewi Indah', 4800000, 32, '3.8', 'Yogyakarta', 0, 0, '', 'Dalam 3 tahun terakhir, saya telah menjadi pekerja rumah tangga yang ahli dalam merapikan rumah, mencuci dan melipat pakaian, serta merawat anak-anak dengan penuh perhatian.', '0845678901', '2023-05-25 01:33:15', '2023-06-09 10:19:53'),
...
(193, 49, 'Rudi Hakim', 5300000, 35, '5.0', 'Jakarta', 24, 24, '', 'Pekerja rumah tangga dengan pengalaman 4 tahun. Saya ahli dalam membersihkan rumah, merapikan pakaian, dan menyiapkan makanan.', '0897890123', '2023-05-25 01:33:15', '2023-06-16 08:53:53'),
...
(255, 0, 'John Doe', 2000, 30, '4.5', 'Madura', 0, 9, NULL, NULL, '08123456789', NULL, NULL),
(256, 0, 'Jane Smith', 1500, 25, '3.8', 'Bali', 0, 10, NULL, NULL, '08234567890', NULL, NULL),
(257, 0, 'Michael Johnson', 1800, 35, '4.2', 'Bekasi', 0, 8, NULL, NULL, '08345678901', NULL, NULL),
(258, 0, 'Emily Davis', 1200, 22, '3.5', 'Depok', 0, 11, NULL, NULL, '08456789012', NULL, NULL),
(259, 0, 'David Wilson', 1600, 28, '4.0', 'Madura', 0, 9, NULL, NULL, '08567890123', NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_points`
--

CREATE TABLE `transaksi_points` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `total_redeem_point` int(11) NOT NULL,
  `tanggal_redeem` date NOT NULL,
...
--
-- Dumping data untuk tabel `transaksi_points`
--

INSERT INTO `transaksi_points` (`id`, `total_redeem_point`, `tanggal_redeem`, `status`, `created_at`, `updated_at`) VALUES
(1, 100000, '2023-06-17', 'success', '2023-06-17 06:55:50', '2023-06-17 06:55:50'),
(2, 100000, '2023-06-17', 'success', '2023-06-17 07:17:14', '2023-06-17 07:17:14');

-- --------------------------------------------------------

--
-- Struktur dari tabel `transaksi_saldos`
--

CREATE TABLE `transaksi_saldos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `kanal_pembayaran` varchar(255) NOT NULL,
...
--
-- Dumping data untuk tabel `transaksi_saldos`
--

INSERT INTO `transaksi_saldos` (`id`, `kanal_pembayaran`, `total_saldo`, `status`, `tanggal_transaksi`, `created_at`, `updated_at`) VALUES
(1, 'BCA', 5000000, 'sukses', '2023-06-16 17:00:00', '2023-06-17 06:57:07', '2023-06-17 06:57:07'),
(2, 'BCA', 10000000, 'sukses', '2023-06-16 17:00:00', '2023-06-17 07:18:21', '2023-06-17 07:18:21');
...
(1, 'adit', NULL, NULL, NULL, 'adit@gmail.com', '0811111111', NULL, NULL, NULL, '$2y$10$gy64TfdPAzxmqtZPrA00buzt4rcuppHwUuEttCdh6RZByFNAzhBIu', NULL, NULL, '2023-06-17 06:39:24', '2023-06-17 06:57:07', NULL, 99645100, 7722500),
(2, 'Adhitya Pratama', NULL, NULL, NULL, 'adit1@gmail.com', '08123567', NULL, NULL, NULL, '$2y$10$cyXyyBsgJvCjF0ySOnl8KOUq6fKm/XBcFkIcECN6.IRTXkD6GA0Pm', NULL, NULL, '2023-06-17 07:09:19', '2023-06-17 07:18:21', NULL, 10000100, 5255000);
...
--
-- Indeks untuk tabel `info_payments`
--
ALTER TABLE `info_payments`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `order_transactions`
  ...
  ADD KEY `order_transactions_prt_id_foreign` (`prt_id`);
...
--
-- Indeks untuk tabel `transaksi_points`
--
ALTER TABLE `transaksi_points`
  ADD PRIMARY KEY (`id`);

--
-- Indeks untuk tabel `transaksi_saldos`
--
ALTER TABLE `transaksi_saldos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `info_payments`
--
ALTER TABLE `info_payments`
...
--
-- AUTO_INCREMENT untuk tabel `transaksi_points`
--
ALTER TABLE `transaksi_points`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT untuk tabel `transaksi_saldos`
--
ALTER TABLE `transaksi_saldos`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `order_transactions`
  ADD CONSTRAINT `order_transactions_prt_id_foreign` FOREIGN KEY (`prt_id`) REFERENCES `prts` (`id`),
  ADD CONSTRAINT `order_transactions_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
