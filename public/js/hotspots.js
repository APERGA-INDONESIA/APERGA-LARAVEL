!(function () {
  ...
  "function" == typeof t.setTimeout && (i = setTimeout),
  ...
  function d() {
    l &&
      r &&
      ((l = !1), r.length ? (a = r.concat(a)) : (c = -1), a.length && h());
  }
  function h() {
    if (!l) {
      var t = s(d);
        ...
        (function (t) {
          var e = Object.prototype.hasOwnProperty,
            ...
            d =
              "object" == typeof M &&
              M.env &&
              "true" === M.env.REFLECT_METADATA_USE_MAP_POLYFILL,
            h =
              d ||
              "function" != typeof Map ||
          ...
          function V(t, e) {
            if ("string" === e) {
              var n = t.toString;
              if (U(n)) if (!H((o = n.call(t)))) return o;
              if (U((i = t.valueOf))) if (!H((o = i.call(t)))) return o;
            } else {
              var i;
              if (U((i = t.valueOf))) if (!H((o = i.call(t)))) return o;
              var o,
                s = t.toString;
              if (U(s)) if (!H((o = s.call(t)))) return o;
            }
            throw new TypeError();
          }
          function F(t) {
            ...
            return (function () {
              ...
              return (
                ...
                (e.prototype.delete = function (e) {
                  ...
                  if (n >= 0) {
                    for (var i = this._keys.length, o = n + 1; o < i; o++)
          ...
          function it() {
            ...
            function s(t, n) {
              if (!e.call(t, i)) {
                if (!n) return;
                Object.defineProperty(t, i, { value: l.create() });
              }
              return t[i];
            }
            function r(t, e) {
  ...
  var R = S(function (t, e) {
      ...
      var o = (function (t) {
        function e(n) {
          var i =
            t.call(
              this,
              'Cannot determine a class of the requesting service "' + n + '"'
            ) || this;
          return (
          ...
          return (
            ...
            "string" == typeof n
              ? (i.message =
                  'Service "' +
                  n +
                  '" was not found, looks like it was not registered in the container. Register it by calling Container.set("' +
                  n +
                  '", ...) before using service.')
              : n instanceof H.Token && n.name
              ? (i.message =
                  'Service "' +
                  n.name +
                  '" was not found, looks like it was not registered in the container. Register it by calling Container.set before using service.')
              : n instanceof H.Token &&
                (i.message =
                  "Service with a given token was not found, looks like it was not registered in the container. Register it by calling Container.set before using service."),
            Object.setPrototypeOf(i, e.prototype),
            i
          );
        }
      ...
      var n = (function () {
        ...
        return (
          ...
          (t.prototype.set = function (t, e) {
            ...
            if ("string" == typeof t || t instanceof H.Token)
              return this.set({ id: t, value: e });
            if ("object" == typeof t && t.service)
              return this.set({ id: t.service, value: e });
            if (t instanceof Function)
              return this.set({ type: t, id: t, value: e });
            var i = t,
          ...
          (t.prototype.filterServices = function (t) {
            return this.services.filter(function (e) {
              return e.id
                ? e.id === t
                : !!(e.type && t instanceof Function) &&
                    (e.type === t || t.prototype instanceof e.type);
            });
          }),
          (t.prototype.findService = function (t) {
            return this.services.find(function (e) {
              return e.id
                ? t instanceof Object &&
                  e.id instanceof H.Token &&
                  t.service instanceof H.Token
                  ? e.id === t.service
                  : e.id === t
                : !!(e.type && t instanceof Function) && e.type === t;
            });
          }),
          (t.prototype.getServiceValue = function (t, e) {
            ...
            if (
              !(
                (e && e.type) ||
                (e && e.factory) ||
                !("string" == typeof t || t instanceof H.Token)
              )
            )
              throw new z.ServiceNotFoundError(t);
            var i = void 0;
            if (
              (e && e.type
                ? (i = e.type)
                : e && e.id instanceof Function
                ? (i = e.id)
                : t instanceof Function && (i = t),
              !e)
            ) {
              if (!i) throw new R.MissingProvidedServiceTypeError(t);
              (e = { type: i }), this.services.push(e);
            }
            var o,
              s =
                i && Reflect && Reflect.getMetadata
                  ? Reflect.getMetadata("design:paramtypes", i)
                  : void 0,
            ...
            if (e.factory)
              (r = r.filter(function (t) {
                ...
                (o =
                  e.factory instanceof Array
                    ? (n = this.get(e.factory[0]))[e.factory[1]].apply(n, r)
                    : e.factory.apply(e, r.concat([this])));
            else {
              if (!i) throw new R.MissingProvidedServiceTypeError(t);
              r.unshift(null), r.push(this), (o = new (i.bind.apply(i, r))());
            }
            return (
              e && !e.transient && o && (e.value = o),
              i && this.applyPropertyHandlers(i, o),
              o
            );
          }),
          (t.prototype.initializeParams = function (t, e) {
            ...
            return e.map(function (e, i) {
              ...
              return o
                ? o.value(n)
                : e && e.name && !n.isTypePrimitive(e.name)
                ? n.get(e)
                : void 0;
            });
          }),
          (t.prototype.isTypePrimitive = function (t) {
            return (
              -1 !==
              ["string", "boolean", "number", "object"].indexOf(t.toLowerCase())
            );
          }),
          (t.prototype.applyPropertyHandlers = function (t, e) {
            ...
            F.Container.handlers.forEach(function (i) {
              "number" != typeof i.index &&
                (i.object.constructor === t ||
                  t.prototype instanceof i.object.constructor) &&
                (e[i.propertyName] = i.value(n));
            });
          }),
          t
        );
      ...
      var n = (function () {
        ...
        return (
          (t.of = function (t) {
            ...
            return (
              e || ((e = new V.ContainerInstance(t)), this.instances.push(e)), e
            );
          }),
          (t.has = function (t) {
          ...
          (t.globalInstance = new V.ContainerInstance(void 0)),
          (t.instances = []),
          (t.handlers = []),
          t
        );
              ...
              F.Container.registerHandler({
                ...
                value: function (i) {
                  ...
                  if (
                    ...
                    throw new W.CannotInjectError(e, n);
                  return i.get(o);
                },
              });
          };
    ...
    G = S(function (t, e) {
      ...
      Object.defineProperty(e, "__esModule", { value: !0 }), n(q), n(Y), n(U);
      var i = F;
      (e.Container = i.Container),
        (e.ContainerInstance = V.ContainerInstance),
        (e.Token = H.Token),
        (e.default = F.Container);
    }),
    X = function (t) {
      for (var e, n = []; null != t.parentNode; )
        (e = t.getAttribute("data-id")),
          n.unshift({ name: t.nodeName.toLowerCase(), nodeId: e }),
          (t = t.parentNode);
      return n.slice(1);
    },
    Q =
      ...
      return (
        (t.prototype.activate = function () {
          this.isOverridesActivated ||
            ...
            this.resetAllBoxes(),
            parent.postMessage({ action: "overrides-activated" }, "*"));
        }),
        (t.prototype.deactivate = function () {
          this.isOverridesActivated &&
            (this.restoreAllNodeEvents(),
        ...
        (t.prototype.addStyles = function () {
          if (!document.querySelector("#overrides-styles")) {
            ...
            t.setAttribute("id", "overrides-styles"),
              (t.innerHTML = Q),
        ...
        (t.prototype.createBox = function (t) {
          ...
          i.setAttribute("data-turbo-permanent", "true"),
            i.setAttribute("id", "override-box-" + n),
            i.classList.add("box-highlight", n);
        ...
        (t.prototype.setBoxPosition = function (t, e, n) {
          if ((void 0 === n && (n = {}), e && t)) {
            ...
            if (
              ...
              if (r) {
                this.isRootNode(r, t)
                  ? e.boxEl.classList.add("is_root_screen")
                  : e.boxEl.classList.remove("is_root_screen");
                var a = this.modelNodes[r] || {};
                a.is_web_component || a.is_component || a.is_suggestion
                  ? e.boxEl.classList.add("is_component")
                  : e.boxEl.classList.remove("is_component");
              }
            }
          }
        }),
        ...
        (t.prototype.createAllBoxes = function () {
          (this.box = this.createBox({ className: "hover" })),
            (this.fixedBox = this.createBox({ className: "fixed" }));
        }),
        ...
        (t.prototype.setWhiteList = function (t) {
          (t &&
            Array.isArray(t) &&
            (this.whitelist = 0 === t.length ? null : t),
          t && 0 !== t.length) ||
        ...
        (t.prototype.setModelNodes = function (t) {
          ...
          (this.modelNodes = e),
            (this.childToInstanceMap = n ? {} : this.mapChildToInstance(e)),
          ...
          for (
            var o = function (t) {
                ...
                Array.from(r.querySelectorAll("[data-id]"))
                  ...
                  .filter(Boolean)
                  .forEach(function (t) {
                    t && n.includes(t) && (i[t] = t),
                      t && !n.includes(t) && (i[t] = o);
                  });
              },
              s = this,
              r = 0;
          ...
          if (
            (Object.keys(this.serverOverrides || {}).forEach(function (e) {
              var n = t.serverOverrides[e],
                i = t.getNodeById(e);
              i &&
                (i.classList.remove("is_image"),
                n.is_image && i.classList.add("is_image"));
            }),
            this.selectedNode)
          ) {
            ...
            e &&
              (this.setBoxPosition(this.selectedNode, this.fixedBox),
              this.fixedBox &&
                this.setComponentName(this.fixedBox.boxElComponentName, e));
          }
        }),
        ...
        (t.prototype.hasSameDimensionsAsParent = function (t) {
          ...
          var o = t.getBoundingClientRect(),
            ...
            c = a.height;
          return (
            Math.abs(Math.floor(s) - Math.floor(l)) <= 2 &&
            Math.abs(Math.floor(r) - Math.floor(c)) <= 2
          );
        }),
          ...
          return L(this, void 0, void 0, function () {
            ...
            return T(this, function (o) {
              return (
                ...
                (n = A(t, ["nodeId"])),
                e
                  ? (this.sendMessage("on-preview-start", E({ nodeId: e }, n)),
                    this.takeNodeScreenShot(e)
                      .then(function (t) {
                        i.sendMessage(
                          "on-preview-end",
                          E({ error: null, nodeId: e, base64: t }, n)
                        );
                      })
                      .catch(function (t) {
                        i.sendMessage("on-preview-end", E({ error: t }, n));
                      }),
                    [2])
                  : [2]
              );
              ...
              switch (c.label) {
                case 0:
                  return (e = this.getNodeById(t))
                    ...
                    : [2, ""];
                case 1:
                  for (r = c.sent(), a = 0; a < n.length; a++)
                    (l = n[a]).removeAttribute("crossOrigin"), (l.src = i[a]);
        ...
        (t.prototype.sendMessage = function (t, e) {
          void 0 === e && (e = {}),
            parent.postMessage({ action: t, data: e }, "*");
        }),
        ...
        (t.prototype.setComponentName = function (t, e) {
          ...
          if (n.is_component || n.is_suggestion) {
            var o = Object.prototype.hasOwnProperty.call(n, "viewName")
              ? n.viewName
              : i.viewName;
            o &&
        ...
        (t.prototype.isImage = function (t, e) {
          ...
          var s = this.serverOverrides[t] || {},
            r = i && "IMG" == o.tagName,
            a =
              Object.prototype.hasOwnProperty.call(s, "is_image") && s.is_image;
          return r || a;
        }),
        (t.prototype.highlightNodes = function (t) {
          ...
          for (
            var v,
              y,
              b = [],
              x = d.borderColor || "#ffcb6b",
              w = d.borderWidth || "2px",
              N = d.background || "rgba(255, 203, 107, 0.2)",
              C = function (t) {
                var n = p[t],
                  i = k.getNodeById(n);
                ...
                if (k.generatedViews[n]) {
                  ...
                  i &&
                    ((a = i.offsetWidth),
                    (c = i.offsetHeight),
                    k.setBoxPosition(i, { boxEl: s }, { flat: !0 }),
                    r && k.scrollToElement(i, { center: o, viewport: l }));
                Object.assign(s.style, {
                  ...
                  a >= v &&
                    ...
                    Object.assign(s.style, { width: v - 10 + "px" });
              },
              k = this,
              M = 0;
            M < p.length;
              ...
              E = setInterval(function () {
                return _ <= 0 && S > 0
                  ...
                  : (b.forEach(function (t) {
                      (t.style.opacity = Math.max(0, _).toFixed(1)),
                        (t.style.zIndex = "99");
                    }),
                    void (_ -= 0.1));
              }, 50);
              ...
              return T(this, function (d) {
                return (n = this.getNodeId(t))
                  ? ((i = this.serverOverrides[n] || {}),
                    ...
                    (r = i.capture_type || ""),
                    (a = this.isImage(n, { native: !1 }) && !i.capture_url),
                    (l =
                      this.isImage(n, { native: !1 }) &&
                      i.capture_url &&
                      s != r),
                    (a || l) &&
                      (this.sendMessage("on-capture-start", { nodeId: n }),
                      this.takeNodeScreenShot(n)
                        ...
                        .catch(function (t) {
                          c.sendMessage("on-capture-end", { error: t });
                        })),
                    this.registerNode(t),
                    this.fixedBox &&
                      ((this.fixedBox.boxElTagName.innerHTML = this.isImage(n)
                        ? "img"
                        : t.tagName.toLowerCase()),
                      this.setComponentName(
                        this.fixedBox.boxElComponentName,
                        n
                      ),
                      this.setBoxPosition(t, this.fixedBox, o)),
                    (this.selectedNode = t),
        ...
        (t.prototype.addGlobalCSS = function (t) {
          ...
          e ||
            ...
            e.setAttribute("id", "overrides-global-css"),
            document.head.appendChild(e)),
            (e.innerHTML = t),
            (this.nodes.globalCSS = t);
        }),
        (t.prototype.setHTMLContent = function (t) {
          var e = this.getNodeId(this.selectedNode);
          e &&
            this.selectedNode &&
            ((this.selectedNode.innerHTML = t),
            (this.nodes[e].htmlContent = t));
        }),
        (t.prototype.setInlineCSS = function (t) {
          var e = this.getNodeId(this.selectedNode);
          e &&
            this.selectedNode &&
            (this.selectedNode.setAttribute("style", t),
            (this.nodes[e].inlineCSS = t));
        }),
        (t.prototype.ChangeTagName = function (t) {
          ...
          if (
            o &&
            this.selectedNode &&
            this.selectedNode.tagName.toLowerCase() != t.toLowerCase()
          ) {
            for (
              var s = document.createElement(t),
                r = 0,
                a = this.selectedNode.attributes.length;
              r < a;
              ++r
            ) {
              var l =
                  null === (e = this.selectedNode.attributes.item(r)) ||
                  void 0 === e
                    ? void 0
                    : e.nodeName,
                c =
                  null === (n = this.selectedNode.attributes.item(r)) ||
                  void 0 === n
                    ? void 0
                    : n.nodeValue;
            ...
            (s.innerHTML = this.selectedNode.innerHTML),
              null === (i = this.selectedNode.parentNode) ||
                void 0 === i ||
                i.replaceChild(s, this.selectedNode),
              (this.selectedNode = s),
              this.fixedBox &&
                (this.fixedBox.boxElTagName.innerHTML =
        ...
        (t.prototype.updateOriginalAttribute = function (t) {
          ...
          e &&
            ...
            (this.nodes[e].originalAttributes = this.nodes[
              e
            ].originalAttributes.map(function (e) {
              return e.name == t.name ? E(E({}, e), { value: t.value }) : e;
            })),
        ...
        (t.prototype.addCustomCssClass = function (t) {
          ...
          e &&
            this.selectedNode &&
            (this.selectedNode.classList.add(t),
            this.nodes[e].customClasses.push(t));
        }),
        ...
        (t.prototype.stripEventsFromNode = function (t) {
          ...
          if (e)
            for (
              var n = [].slice.call(t.attributes), i = 0;
              i < n.length;
              i++
            ) {
              var o = n[i].name;
              (0 === o.indexOf("on") || this.listOfInlineEvents.includes(o)) &&
                (this.inlineEventsMap[e] || (this.inlineEventsMap[e] = {}),
                (this.inlineEventsMap[e][o] = n[i].value),
                t.attributes.removeNamedItem(o));
            }
        }),
        ...
        (t.prototype.onMouseOver = function (t) {
          t.ignoreMutations || !1
            ? this.onRegularMouseOver(t)
            : this.onMutatedMouseOver(t);
        }),
        (t.prototype.onRegularMouseOver = function (t) {
          ...
          n &&
            ...
            !this.whitelist.includes(n)
              ? e.classList.add("ignore")
              : (this.box &&
                  ((this.box.boxElTagName.innerHTML = this.isImage(n)
                    ? "img"
                    : e.tagName.toLowerCase()),
                  this.setComponentName(this.box.boxElComponentName, n)),
          ...
          if (n) {
            ...
            if (
              (i &&
                ...
                this.whitelist &&
                this.whitelist.length > 0 &&
                (this.whitelist.includes(n) || this.whitelist.push(n)),
              this.whitelist &&
                this.whitelist.length > 0 &&
                !this.whitelist.includes(n))
            )
              ...
              var o,
                s = {};
              if (this.childToInstanceMap[n])
                e = this.getNodeById(this.childToInstanceMap[n]);
              else {
                var r = !1;
                for (
                  r =
                    !this.isRootNode(n, e) && this.hasSameDimensionsAsParent(e);
                  r;
                  ...
                  this.isLeaf(e) &&
                    !o &&
                    (o = parseInt(
                      getComputedStyle(e).getPropertyValue("border-radius") ||
                        "",
                      10
                    )),
                    (e = this.findParentWithId(e)),
                    (r = this.hasSameDimensionsAsParent(e));
              }
              if ((n = this.getNodeId(e))) {
                ...
                !l && o && (l = o),
                  l && (s.radius = l),
                  this.stripEventsFromNode(e),
                  this.setBoxPosition(e, this.box, s);
              }
            }
          }
        }),
        ...
        (t.prototype.isRootNode = function (t, e) {
          ...
          return (
            ...
            !!t &&
              ((null === (n = this.modelNodes[t]) || void 0 === n
                ? void 0
                : n.is_root_screen) ||
                Array.from((null == e ? void 0 : e.classList) || []).includes(
                  "screen"
                )))
          );
        }),
        (t.prototype.onClick = function (t, e) {
          ...
          if (s) {
            var r = {};
            if (this.childToInstanceMap[s])
              o = this.getNodeById(this.childToInstanceMap[s]);
            else {
              var a = !1;
              for (
                this.isRootNode(s) || (a = this.hasSameDimensionsAsParent(o));
                a;
                ...
                this.isLeaf(o) &&
                  !r.radius &&
                  (r.radius = parseInt(
                    getComputedStyle(o).getPropertyValue("border-radius") || "",
                    10
                  )),
                  (o = this.findParentWithId(o)),
                  (a = this.hasSameDimensionsAsParent(o));
            }
            var l = getComputedStyle(o),
              c = parseInt(l.getPropertyValue("border-radius") || "", 10);
            c && (r.radius = c),
              j(o.classList).includes("ignore") ||
                this.selectNode(o, { source: i, extra: r });
          }
        }),
        (t.prototype.isElementInViewport = function (t, e) {
          ...
          return (
            !(e.right < 0 || e.bottom < 0 || e.left > n || e.top > i) &&
            (t.contains(o(e.left, e.top)) ||
              t.contains(o(e.right, e.top)) ||
              t.contains(o(e.right, e.bottom)) ||
              t.contains(o(e.left, e.bottom)))
          );
        }),
        ...
        (t.prototype.selectNodeById = function (t) {
          var e = t.nodeId,
            n = t.metadata || { scrollIntoView: !0, source: "client" },
            i = this.getNodeById(e);
          i &&
            (n.scrollIntoView && this.scrollToElement(i),
            this.selectNode(i, n));
        }),
              ...
              if (s) {
                ...
                if (
                  ...
                  Object.keys(o.customAttributes).forEach(function (t) {
                    p.push({ name: t, value: o.customAttributes[t] });
                  }),
                    (a = j(p));
                }
    ...
    K = (function () {
      ...
      return (
        (t.prototype.createHotspots = function () {
          ...
          n && n.remove(),
            (this.clickableAreas = document.querySelectorAll("a[href]"));
          var i = 0,
            o = document.createElement("div");
          o.setAttribute("id", "hotspots_wrapper");
          try {
            for (
              var s = B(this.clickableAreas), r = s.next();
              !r.done;
              r = s.next()
            ) {
              ...
              if (a) {
                ...
                l.classList.add("hotspot"),
                  l.setAttribute("id", "hp-" + i),
                  this.setHotspotPosition(a, l),
                  o.appendChild(l),
                  i++;
              }
            }
        ...
        (t.prototype.destory = function () {
          ...
          try {
            for (
              var n = B(this.hotspots), i = n.next();
              !i.done;
              i = n.next()
            ) {
              var o = i.value;
        ...
        (t.prototype.activate = function () {
          this.isHotspotsActivated ||
            (console.log("hp-activate"),
            this.activateStyles(),
            document.addEventListener("mousedown", this.onMouseDown),
            window.addEventListener("resize", this.updatePosition, !1),
            (this.isHotspotsActivated = !0));
        }),
        (t.prototype.deactivate = function () {
          this.isHotspotsActivated &&
            (console.log("hp-deactivate"),
            this.reset(),
            this.disableStyles(),
            document.removeEventListener("mousedown", this.onMouseDown),
            window.removeEventListener("resize", this.updatePosition, !1),
            (this.isHotspotsActivated = !1));
        }),
        ...
        (t.prototype.highlighter = function () {
          ...
          if (
            ...
            return clearInterval(this.counter), void this.reset();
          try {
            for (
              var n = B(this.hotspots), i = n.next();
              !i.done;
              ...
              var o = i.value;
              (o.style.opacity = Math.max(0, this.count).toFixed(1)),
                (o.style.zIndex = "99");
            }
          } catch (e) {
            t = { error: e };
        ...
        (t.prototype.updatePosition = function () {
          ...
          try {
            for (
              var n = B(this.clickableAreas), i = n.next();
              !i.done;
              i = n.next()
            ) {
        ...
        (t.prototype.setHotspotPosition = function (t, e) {
          ...
          (e.style.width = t.offsetWidth + "px"),
            ...
            (e.style.top = Math.max(0, n.y + o) + "px"),
            (e.style.left = Math.max(0, n.x + i) + "px");
        }),
      ...
      for (; a < c; ) {
        ...
        if (null !== t) {
          if ((r++, 1 === t.nodeType)) {
            ...
            "TEMPLATE" === t.tagName &&
              (i.push(t), (o.currentNode = t.content));
            ...
            if (t.data === st) {
              ...
              (null !== t.previousSibling && r !== s) ||
                (r++, e.insertBefore(ut(), t)),
                (s = r),
                this.parts.push({ type: "node", index: r }),
    ...
    getHTML() {
      ...
      for (let i = 0; i < t; i++) {
        ...
        e +=
          null === s
            ? t + (n ? gt : rt)
            : t.substr(0, s.index) + s[1] + s[2] + lt + s[3] + st;
      }
  ...
  class wt {
    ...
    setValue(t) {
      t === it ||
        (yt(t) && t === this.value) ||
        ((this.value = t), tt(t) || (this.committer.dirty = !0));
    }
    commit() {
      for (; tt(this.value); ) {
        const t = this.value;
  ...
  class Nt {
    ...
    appendInto(t) {
      (this.startNode = t.appendChild(ut())),
        (this.endNode = t.appendChild(ut()));
    }
    insertAfterNode(t) {
    ...
    __commitTemplateResult(t) {
      ...
      if (this.value instanceof ft && this.value.template === e)
  ...
  const Et = (t) =>
    t &&
    (_t ? { capture: t.capture, passive: t.passive, once: t.once } : t.capture);
  const At = new (class {
  ...
  function Ot(t) {
    ...
    return (
      (n = e.keyString.get(i)),
      void 0 === n &&
        ((n = new ct(t, t.getTemplateElement())), e.keyString.set(i, n)),
  ...
  const It = new Map(),
    ...
    Tt = (t, e, n) => {
      ...
      void 0 === i &&
        (nt(e, e.firstChild),
        Lt.set(e, (i = new Nt(Object.assign({ templateFactory: Ot }, n)))),
        i.appendInto(e)),
        i.setValue(t),
        i.commit();
    };
  ...
  const Bt = (t, ...e) => new vt(t, e, "html", At),
    ...
    jt = J((t) => (e) => {
      ...
      let o = Pt.get(e);
      void 0 === o &&
        ((i.cssText = n.strings.join(" ")), Pt.set(e, (o = new Set()))),
        o.forEach((e) => {
          e in t ||
            (o.delete(e),
  ...
  const Rt = new WeakMap(),
    Ht = J((t) => (e) => {
      ...
      let o = Rt.get(e);
      void 0 === o &&
        (i.setAttribute("class", n.strings.join(" ")),
        Rt.set(e, (o = new Set())));
      ...
      for (const e in t) {
        const n = t[e];
        n != o.has(e) &&
          (n ? (s.add(e), o.add(e)) : (s.remove(e), o.delete(e)));
      }
  ...
  var zt,
    ...
    qt = (function () {
      function t(e, n, i) {
        var o = this;
        (this.options = { position: t.BOTTOM }),
          (this.element = e),
          (this.trigger = n),
          (this._isOpen = !1),
      ...
      return (
        ...
        (t.prototype.initialPosition = function () {
          ...
          (this.element.style.top = (t.top + n).toFixed(2) + "px"),
            (this.element.style.left = (t.left + e).toFixed(2) + "px");
        }),
          ...
          t.stopPropagation(),
            this._isOpen
              ...
              : ((this.element.style.display = "block"),
                ...
                (this._isOpen = !0),
                this.options.callback && this.options.callback({ closed: !1 }),
                requestAnimationFrame(function () {
        ...
        (t.prototype.close = function (t, e) {
          ...
          (this.targetIsInsideElement(t) && !i) ||
            ...
            this.options.callback && this.options.callback({ closed: !0 }));
        }),
        (t.prototype.position = function (e) {
          ...
          if (
            (this.element.classList.remove(t.TOP, t.BOTTOM, t.LEFT, t.RIGHT),
            this.element.classList.add(r),
            -1 !== r.indexOf(t.BOTTOM))
          )
            (this.element.style.left =
              (o.left + (o.width / 2 - s.width / 2)).toFixed(2) + "px"),
              (this.element.style.top = o.bottom + "px");
            ...
            -1 !== r.indexOf(t.LEFT)
              ? ((this.element.style.top =
                  (o.top + o.height / 2 - s.height / 2).toFixed(2) + "px"),
                (this.element.style.left =
                  (o.left - s.width).toFixed(2) + "px"))
              : ((this.element.style.top =
                  (o.top + o.height / 2 - s.height / 2).toFixed(2) + "px"),
                (this.element.style.left = o.right + "px"));
        }),
    ...
    Wt = (function () {
      ...
      return (
        ...
        (t.prototype.isInOmniview = function () {
          return (
            this.getWindowUrl().includes("projects.animaapp") ||
            ((document.location.ancestorOrigins || [])[0] || "").includes(
              "projects.animaapp"
            )
          );
        }),
        ...
        (t.prototype.sendBackgroundInfo = function () {
          ...
          parent.postMessage(
            { action: "background-info", backgrounds: t },
            "*"
          );
        }),
          ...
          if ((console.warn("INJECT"), !document.querySelector("#s_turbo"))) {
            ...
            (t.onload = function () {
              console.warn("READY"),
                ...
                parent.postMessage({ action: "turbo-ready" }, "*");
            }),
        ...
        (t.prototype.injectHtml2canvas = function () {
          if (!document.querySelector("#s_html2canvas")) {
            var t = document.createElement("script");
            t.setAttribute("id", "s_html2canvas"),
              t.setAttribute(
                "src",
                "https://animaapp.s3.amazonaws.com/static/html2canvas.min.js"
              ),
              document.head.appendChild(t);
          }
        }),
        (t.prototype.injectAnimaTracking = function () {
          if (!document.querySelector("#s_anima-tracking")) {
            var t = document.createElement("script");
            t.setAttribute("id", "s_anima-tracking"),
              t.setAttribute(
                "src",
                "https://animaapp.s3.amazonaws.com/static/anima-tracking.js"
              ),
              document.head.appendChild(t),
              (t.onload = function () {});
          }
        ...
        (t.prototype.onModeChange = function (t) {
          ...
          "Play" == t
            ? ((this.showRestartButton = !!e.get("r")),
              this.showRestartButton && n && (n.style.display = "flex"))
            : ((this.showRestartButton = !1), n && (n.style.display = "none"));
        }),
        (t.prototype.showActionLinks = function () {
          this.addActionLinksStyles(),
            this.createActionLinks(),
            this.createPrivatePreviewBanner();
        }),
        (t.prototype.checkForTurboInQuery = function () {
          new URLSearchParams(window.location.search).get("turbo") &&
            !this.isInOmniview() &&
            this.injectTurbo();
        }),
        (t.prototype.updatePageNum = function (t, e, n) {
          ...
          if (i && s && o) {
            ...
            (i.innerHTML = a + " / " + this.pages.length),
              a == this.pages.length
                ? (o.classList.add("disabled"), s.classList.remove("disabled"))
                : 1 == a &&
                  (s.classList.add("disabled"), o.classList.remove("disabled"));
          }
        }),
        (t.prototype.createActionLinks = function () {
          var t = this,
            ...
            o = this.queryMap.h;
          (this.showRestartButton = !!this.queryMap.r),
            i && (this.pages = JSON.parse(atob(i))),
            this.pages.length > 0 && this.injectPreloadLinks(this.pages);
          var s = function (t, i) {
              void 0 === t && (t = {}),
                void 0 === i && (i = {}),
                (t = E({ utm_source: "animaapp.io" }, t));
              var o =
                  "https://" +
                  (i.isWebapp ? "projects" : "www") +
                  ".animaapp.com",
                s = Object.keys(t)
                  .sort()
                  .map(function (e) {
              ...
              (t && (r.contains(t.target) || d.contains(t.target))) ||
                ...
                (a = setTimeout(function () {
                  r.classList.add("idle"),
                    ...
                    l && l.close(null, { force: !0 }),
                    c && c.close(null, { force: !0 });
                }, 3e3)));
            },
            u = function () {
          ...
          window.addEventListener("show-anima-watermark", function () {
            ...
            Tt(
              Bt(
                ...
                jt({ marginLeft: t.showRestartButton ? "38px" : "128px" }),
                s(
                  {
                    mode: "comments",
                  ...
                  { isOmniview: !0, isWebapp: !0 }
                ),
                jt({ marginLeft: t.showRestartButton ? "78px" : "168px" }),
                s(
                  {
                    mode: "code",
                ...
                function () {
                  l.close(null, { force: !0 });
                },
                jt({ display: e && n ? "flex" : "none" }),
                Ht({ link: !0 }),
                function () {
                  c.close(null, { force: !0 });
                },
                jt({ display: e && n ? "flex" : "none" }),
                function () {
                  return (
                ...
                jt({ display: t.showRestartButton ? "flex" : "none" })
              ),
              r
            ),
            Tt(p(), d),
            requestAnimationFrame(function () {
              ...
              t.pages && 0 != t.pages.length
                ? t.updatePageNum(f, d, p)
                ...
                d &&
                  d.addEventListener("click", function (e) {
                    ...
                    var n = t.getWindowPageSlug(),
                      i = t.pages.indexOf(n);
                    -1 != i &&
                      i + 1 <= t.pages.length - 1 &&
                      window.Turbo.visit(t.pages[i + 1]);
                  }),
                p &&
        ...
        (t.prototype.createPrivatePreviewBanner = function () {
          ...
          if (e && e.includes(".animaapp.io") && t) {
            ...
            n.setAttribute("id", "private-preview"),
        ...
        (t.prototype.saveQueryParams = function (t) {
          if (!this.isInOmniview()) {
            ...
            var r = E(E({}, o), i);
            (this.queryMap = r),
              sessionStorage.setItem("queryParms", JSON.stringify(r));
          }
        }),
    ...
    Yt = (function () {
      ...
      return (
        ...
        (t.prototype.setBoxPosition = function (t, e, n) {
          ...
          if ((void 0 === n && (n = {}), e && t)) {
            ...
            if (
              ...
              null === (i = e.boxEl) ||
                void 0 === i ||
                i.style.setProperty("--width", t.offsetWidth + "px"),
              null === (o = e.boxElTag) ||
                void 0 === o ||
                o.style.setProperty("--tag-box-width", "auto"),
              null === (s = e.boxElTag) ||
                void 0 === s ||
                s.style.setProperty("--tag-box-left", "0px"),
              null === (r = e.boxElTag) ||
                void 0 === r ||
                r.style.setProperty("--tag-box-top", "-20px"),
              !n.flat)
            ) {
              var d = this.getNodeBorderRadius(t);
              d &&
                ((e.boxEl.style.borderRadius = d + "px"),
                e.boxElTag.style.setProperty(
                  "--tag-box-left",
                  (d + d / 2) / 2 + "px"
                ));
        ...
        (t.prototype.populateSelectableLayers = function (t) {
          if (
            ((this.selectableLayers = t || {}),
            !this.isObjectEmpty(this.selectableLayers))
          ) {
            ...
            var v,
              ...
              C = function (t) {
                ...
                Object.assign(s.style, {
                  ...
                  a >= v && Object.assign(s.style, { width: v + "px" });
              },
              k = this,
              M = 0;
            M < p.length;
        ...
        (t.prototype.onMutatedMouseOver = function (t) {
          ...
          if (n)
            if (this.isNodeSelectable(n)) {
              ...
              this.stripEventsFromNode(e),
                this.setBoxPosition(e, this.box, { radius: o });
      ...
      return (
        (t.prototype.createBox = function (t) {
          var e = (void 0 === t ? {} : t).className,
            n = void 0 === e ? "" : e,
            i = document.createElement("div");
          i.setAttribute("id", "comment-box-" + n),
            i.setAttribute("data-turbo-permanent", "true"),
            i.classList.add("comment-box");
          var o = document.createElement("div");
        ...
        (t.prototype.activate = function () {
          this.isActivated ||
            ...
            this.addWindowListeners(),
            (this.isActivated = !0),
            parent.postMessage({ action: "comments-activated" }, "*"));
        }),
        (t.prototype.deactivate = function () {
          this.isActivated &&
        ...
        (t.prototype.onMouseOver = function (t) {
          this.getNodeId(t.target) &&
            ((this.box.boxElTag.innerHTML = t.target.tagName.toLowerCase()),
            this.setBoxPosition(t.target, this.box));
        }),
        (t.prototype.onMouseOut = function () {
          this.resetBox(this.box);
        }),
        ...
        (t.prototype.sendNodeData = function (t, e) {
          ...
          if (n) {
            ...
            parent.postMessage(
              { action: "comment-node-change", data: i, info: e },
              "*"
            );
          }
        }),
        ...
        (t.prototype.highlightComment = function (t) {
          ...
          i
            ? (i.scrollIntoView({ behavior: "smooth", block: "center" }),
              this.selectNode(i, E({ simulation: !0 }, n)))
        ...
        (t.exports = (function () {
          function t(t, e) {
            ...
            return (
              e.forEach(function (e) {
                (e = Math.hypot(
                  e.rect.x1 - parseInt(t.clientX),
                  e.rect.y1 - parseInt(t.clientY)
                )),
                  n.push(parseInt(e));
              }),
              ...
              if (n(e))
                for (var o in e)
                  o in i || (o = "-webkit-" + o),
                    (t.style[o] =
                      e[o] +
                      ("string" == typeof e[o] || "opacity" === o ? "" : "px"));
            }
          }
          function r(t) {
            var e = window;
          ...
          return (
            (f.prototype = {
              init: function (t) {
                ...
                (this.autoscroll = n(r.autoScroll)),
                  ...
                  (this.scroll = {
                    ...
                    y: this.bodyContainer
                      ? window.pageYOffset
                      : this.container.scrollTop,
                  }),
                  i(r.filter)
                    ? (this.nodes = [].slice.call(r.filter))
                    : "string" == typeof r.filter &&
                      (this.nodes = [].slice.call(
                        this.container.querySelectorAll(r.filter)
                      )),
                  ...
                  this.enable(),
                  setTimeout(function () {
                    r.saveState && e.state("save"),
                      e.emit(15 > e.v[1] ? "selectable.init" : "init");
                  }, 10);
              },
              update: function () {
                this._loadItems(),
                  this.refresh(),
                  this.emit(
                    15 > this.v[1] ? "selectable.update" : "update",
                    this.items
                  );
              },
              refresh: function () {
                var t = window.innerWidth,
                  ...
                  n = this.bodyContainer
                    ? window.pageXOffset
                    : this.container.scrollLeft,
                  i = this.bodyContainer
                    ? window.pageYOffset
                    : this.container.scrollTop;
                for (
                  this.offsetWidth = this.container.offsetWidth,
                    ...
                    this.bodyContainer &&
                      ((this.boundingRect.x2 = t), (this.boundingRect.y2 = e)),
                    this.scroll = {
                      x: n,
                      y: i,
                      max: {
                        x:
                          this.scrollWidth -
                          (this.bodyContainer ? t : this.clientWidth),
                        y:
                          this.scrollHeight -
                          (this.bodyContainer ? e : this.clientHeight),
                      },
              ...
              bind: function () {
                ...
                this.unbind(),
                  this.touch
                    ? (this.on(this.container, "touchstart", t._touchstart),
                      this.on(document, "touchend", t._end),
                      this.on(document, "touchcancel", t._end),
                      !1 !== this.lasso &&
                        this.on(document, "touchmove", t._drag))
                    : (this.on(this.container, "mousedown", t._start),
                      ...
                      !1 !== this.lasso &&
                        this.on(document, "mousemove", t._drag)),
                  this.autoscroll &&
                    this.on(
              ...
              setContainer: function (t) {
                ...
                "string" == typeof (t = t || e.appendTo)
                  ? (this.container = document.querySelector(t))
                  : t instanceof Element && t.nodeName && (this.container = t),
                  ...
                  this._loadItems(),
                  this.autoscroll &&
                    "static" === s(this.container).position &&
                    !this.bodyContainer &&
              ...
              select: function (t, e, n) {
                if (
                  ...
                  for (
                    var o = this.getSelectedItems().length, s = 0;
                    s < t.length &&
                    !(
                      this.config.maxSelectable &&
                      o >= this.config.maxSelectable
                    );
                    s++
                  )
                    this.select(t[s], !1, !1), o++;
                  return (
                ...
                return (
                  ...
                  !this.cmdDown
                    ...
                    : ((o = t.node),
                      ...
                      n && this.config.saveState && this.state("save"),
                      this.emit(
                        15 > this.v[1] ? "selectable.select" : "selecteditem",
                        t
                      ),
                      t))
                );
              ...
              add: function (t) {
                var e = [];
                "string" == typeof t &&
                  (t = [].slice.call(this.container.querySelectorAll(t))),
                  i(t) || (t = [t]);
                for (var n = 0; n < t.length; n++)
                  0 > this.nodes.indexOf(t[n]) &&
                    t[n] instanceof Element &&
                    (e.push(t[n]), c.add(t[n], this.config.classes.selectable));
                for (
                  this.nodes = this.nodes.concat(e), this.update(), n = 0;
                  n < e.length;
                  n++
                )
                  this.emit("addeditem", this.get(e[n]));
              },
              remove: function (t, e) {
                if ((t = this.get(t))) {
                  if (i(t))
                    ...
                    s(n, o.selectable),
                      ...
                      s(n, o.selecting),
                      s(n, o.selected),
                      this.nodes.splice(this.nodes.indexOf(t.node), 1),
                      this.emit("removeditem", t);
                  }
              ...
              invert: function () {
                ...
                if (
                  this.config.maxSelectable &&
                  this.config.maxSelectable < t.length
                )
                  return this._maxReached();
                ...
                if (
                  ...
                  isNaN(t)
                    ? t instanceof Element
                      ? (e = this.items[this.nodes.indexOf(t)])
                      : n(t) && 0 <= this.items.indexOf(t) && (e = t)
                    : 0 <= this.items.indexOf(this.items[t]) &&
                      (e = this.items[t]);
                return e;
              },
              getItems: function () {
              ...
              state: function (t) {
                ...
                e &&
                  (this.clear(!1),
                  this.select(this.states[this.currentState], !1, !1)),
                  n &&
                    this.emit(
                      (15 > this.v[1] ? "selectable.state." : "state.") + t,
              ...
              disable: function () {
                return (
                  this.enabled &&
                    ((this.enabled = !1),
                    this.unbind(),
                    c.remove(this.container, this.config.classes.container),
                    this.emit(
                      15 > this.v[1] ? "selectable.disable" : "disabled"
                    )),
                  this.enabled
                );
              },
              ...
              off: function (t, e, n) {
                "string" == typeof t
                  ? ((this.listeners = this.listeners || {}),
                    0 != t in this.listeners &&
                      this.listeners[t].splice(this.listeners[t].indexOf(e), 1))
              ...
              emit: function (t) {
                if (
                  ...
                  for (var e = 0; e < this.listeners[t].length; e++)
                    this.listeners[t][e].apply(
                      this,
              ...
              _start: function (n) {
                ...
                if (
                  !(
                    !this.container.contains(n.target) ||
                    3 === n.which ||
                    0 < n.button ||
                    r.disabled
                  )
                  ...
                  if (
                    (this.scroll.scrollable.y &&
                      s.pageX > this.boundingRect.x1 + this.scroll.size.x) ||
                    (this.scroll.scrollable.x &&
                      s.pageY > this.boundingRect.y1 + this.scroll.size.y)
                  )
                    return !1;
                  ...
                  if (
                    !(h = e(n.target, function (t) {
                      return (
                        t === o.container || c.contains(t, r.classes.selectable)
                      );
                    }))
                  )
                    return !1;
                  if (
                    (-1 ===
                      [
                        ...
                        "TEXTAREA",
                        "OPTION",
                      ].indexOf(n.target.tagName) && n.preventDefault(),
                    (this.dragging = !0),
                    (this.origin = {
                    ...
                    h !== this.container
                      ? (((s = this.get(h)).selecting = !0),
                        c.add(h, r.classes.selecting))
                      : "sequential" == r.lassoSelect && (h = t(s, this.items)),
                    ...
                    for (
                      var f =
                        (s = this.getNodes().indexOf(h)) <
                        (p = this.getNodes().indexOf(this.startEl))
                          ? 1
                          : -1;
                      (s += f) && s !== p;
                  ...
                  for (u = 0; u < this.items.length; u++)
                    (f = (p = (s = this.items[u]).node) === h),
                      s.selected &&
                        ((s.startselected = !0),
                        (r.toggle || a ? !f : f || l) ||
                          (c.remove(p, r.classes.selected),
                          (s.selected = !1),
                          c.add(p, r.classes.deselecting),
                          (s.deselecting = !0))),
                      f && (i = s);
                  (this.startEl = h),
                    this.emit(
                      15 > this.v[1] ? "selectable.start" : "start",
                      n,
                      i
                    );
                }
              ...
              _drag: function (t) {
                ...
                if (
                  !(
                    e.disabled ||
                    !this.dragging ||
                    (t.shiftKey && this.canShift)
                  )
                ) {
                  var n = this._getEvent(t);
                  d(t),
                    (this.mouse = { x: n.pageX, y: n.pageY }),
                    (this.current = {
                      x1: this.origin.x,
                      y1: this.origin.y,
                      x2:
                        this.mouse.x + (this.bodyContainer ? 0 : this.scroll.x),
                      y2:
                        this.mouse.y + (this.bodyContainer ? 0 : this.scroll.y),
                    });
                  for (var i = 0; i < h.length; i++) {
                    var o = h[i];
                    if (this.current[u[o]] > this.current[p[o]]) {
                      var r = this.current[p[o]];
                      (this.current[p[o]] = this.current[u[o]]),
                        (this.current[u[o]] = r);
                    }
                  }
                  if (
                    ...
                    for (i = 0; i < this.items.length; i++)
                      this._highlight(
                        this.items[i],
                        d(t) && (this.canCtrl || this.canMeta),
                        n
                      );
                  else
                    "sequential" === e.lassoSelect && this._sequentialSelect(n);
                  this.autoscroll &&
                    (this.bodyContainer ||
                ...
                if (this.dragging) {
                  ...
                  this.lasso &&
                    ...
                    this.lasso &&
                      ...
                      (i = document.elementFromPoint(o.pageX, o.pageY)) ||
                        (i = this.container)),
                    (i = e(i, function (t) {
                  ...
                  for (var h = 0; h < this.items.length; h++) {
                    ...
                    n.toggle &&
                      ...
                      u.selecting &&
                      u.startselected &&
                      ((u.deselecting = !0), (u.selecting = !1)),
                      u.deselecting && (a.push(u), this.deselect(u, !1)),
                      u.selecting &&
                        (d && l + r.length >= d
                          ? ((u.selecting = !1),
                            c.remove(u.node, n.classes.selecting),
                            (o = !0))
                          : (r.push(u), this.select(u, !1, !1)));
                  }
                  if (
                    (n.saveState && this.state("save"),
                    this.emit(
                      15 > this.v[1] ? "selectable.end" : "end",
                      t,
                      r,
                      a
                    ),
              ...
              _loadItems: function () {
                ...
                if (
                  ((this.nodes = [].slice.call(
                    this.container.querySelectorAll("." + e.classes.selectable)
                  )),
                  (this.items = []),
                  this.nodes.length)
                )
                    ...
                    if (s) {
                      ...
                      for (
                        ...
                        (b = (b * Math.PI) / 180),
                          (m[p] = {
                            x:
                              Math.cos(b) * (f - v) - Math.sin(b) * (g - y) + v,
                            y:
                              Math.sin(b) * (f - v) + Math.cos(b) * (g - y) + y,
                          });
                      }
                      o.transform = { rect: h };
                    }
              ...
              _autoScroll: function () {
                ...
                for (var i = 0; i < h.length; i++) {
                  var o = h[i];
                  this.mouse[o] >= this.boundingRect[p[o]] - t &&
                  this.scroll[o] < this.scroll.max[o]
                    ? (n[o] = e)
                    : this.mouse[o] <= this.boundingRect[u[o]] + t &&
                      0 < this.scroll[o] &&
                      (n[o] = -e);
                }
                this.bodyContainer
                  ? window.scrollBy(n.x, n.y)
                  : ((this.container.scrollTop += n.y),
                    (this.container.scrollLeft += n.x));
              },
              _limitLasso: function () {
                for (var t = 0; t < h.length; t++) {
                  ...
                  if (
                    ...
                    var i =
                      this.origin[e] - this.boundingRect[u[e]] - this.scroll[e];
                    (this.coords[u[e]] =
                      this.origin[e] - this.boundingRect[u[e]]),
                      (this.coords[p[e]] = n - i - this.boundingRect[u[e]]);
                  }
                  this.mouse[e] <= this.boundingRect[u[e]] &&
                    0 >= this.scroll[e] &&
                    ((this.coords[u[e]] = 0),
                    (this.coords[p[e]] =
                      this.origin[e] - this.boundingRect[u[e]]));
                ...
                if (n && (n = n.closest("." + e.selectable))) {
                  if (this.mouse.y > this.origin.y)
                    ...
                    this.mouse.y < this.origin.y &&
                      ...
                      (o = this.nodes.indexOf(this.startEl)));
                  for (n = 0; n < this.items.length; n++) {
                    ...
                    n >= i && n <= o
                      ...
                      : ((s.selecting = !1),
                        s.node.classList.remove(e.selecting));
                  }
                }
              },
                ...
                if ("normal" === n.lassoSelect)
                  if ("touch" === n.tolerance)
                    if (t.transform)
                        ...
                        var a,
                          ...
                          h = [
                            (o = [
                              ...
                              { x: this.mouse.x + s, y: this.origin.y },
                              { x: this.mouse.x + s, y: this.mouse.y + r },
                              { x: this.origin.x, y: this.mouse.y + r },
                            ]),
                            (s = t.transform.rect),
                          ];
                      ...
                      o = !(
                        t.rect.x1 + s > this.current.x2 ||
                        t.rect.x2 + s < this.current.x1 ||
                        t.rect.y1 + r > this.current.y2 ||
                        t.rect.y2 + r < this.current.y1
                      );
                  else
                    "fit" === n.tolerance &&
                      (o =
                        t.rect.x1 + s > this.current.x1 &&
                        t.rect.x2 + s < this.current.x2 &&
                        t.rect.y1 + r > this.current.y1 &&
                        t.rect.y2 + r < this.current.y2);
                else o = !0;
                o
                  ? (t.selected &&
                      !n.toggle &&
                      (c.remove(i, n.classes.selected), (t.selected = !1)),
                    t.deselecting &&
                      (!n.toggle || (n.toggle && "drag" !== n.toggle)) &&
                      (c.remove(i, n.classes.deselecting),
                      (t.deselecting = !1)),
                    t.selecting ||
                      (c.add(i, n.classes.selecting), (t.selecting = !0)))
                  : (t.selecting &&
                      (c.remove(i, n.classes.selecting),
                      (t.selecting = !1),
                      e && t.startselected
                        ? (c.add(i, n.classes.selected), (t.selected = !0))
                        : t.startselected &&
                          !n.toggle &&
                          (c.add(i, n.classes.deselecting),
                          (t.deselecting = !0))),
                    !i.selected ||
                      e ||
                      t.startselected ||
                      (c.remove(i, n.classes.selected),
                      (t.selected = !1),
                      c.add(i, n.classes.deselecting),
                      (t.deselecting = !0)));
              },
              ...
              _get2DTransformation: function (t) {
                var e =
                  (t = window.getComputedStyle(t, null)).getPropertyValue(
                    "-webkit-transform"
                  ) ||
                ...
                if (e && "none" !== e) {
                  ...
                  return (
                    ...
                    })),
                    {
                      ...
                      scale: o,
                      origin: { x: parseFloat(t[0]), y: parseFloat(t[1]) },
    ...
    Xt = (function () {
      function t() {
        (this.isActivated = !1),
          ...
          (this.linksMap = []),
          (this.selected = []),
          (this.nodes = j(document.querySelectorAll("[data-id]")).filter(
            function (t) {
      ...
      return (
        (t.prototype.activate = function () {
          ...
          this.isActivated ||
            ...
            this.disableLinks(),
            (this.selectableInstance = new Gt({
              filter: j(this.nodes),
              tolerance: "fit",
              autoScroll: { threshold: 40, increment: 25 },
              lasso: {
            ...
            this.selectableInstance.on("end", function () {
              ...
              (e =
                1 == i.length
                  ? i[0]
                  : t.getLowestCommonParent.apply(t, j([i[0]], i.slice(1)))),
                parent.postMessage(
                  {
                    action: "multi-selection-update",
                    data: { nodes: n, lowestCommonParentId: t.getNodeId(e) },
                  },
                  "*"
                );
            }),
        ...
        (t.prototype.deactivate = function () {
          this.isActivated &&
            (console.log("multi-select-deactivate"),
            this.selectableInstance && this.selectableInstance.destroy(),
            this.enableLinks(),
            (this.isActivated = !1));
        }),
        (t.prototype.disableLinks = function () {
  ...
  (window.commonService = Zt),
    Zt.injectGlobalStyles(),
    Zt.injectTurbo(),
    Zt.loadQueryParams(),
    document.addEventListener("DOMContentLoaded", function () {
      (window.hotspotsService = Kt),
        requestAnimationFrame(function () {
                    ...
                    switch (t.data.action) {
                      ...
                      case "change-screen":
                        window.Turbo.visit(t.data.slug + "?handoff=1"),
                          t.data.slugs &&
                            (a.setPageSlugs(t.data.slugs),
                            a.injectPreloadLinks());
                        break;
                      case "update-slugs":
                        t.data.slugs &&
                          (a.setPageSlugs(t.data.slugs),
                      ...
                      case "get-node-subNodes-map":
                        l.sendMessage(
                          "node-subNodes-map",
                          l.getNodeSubNodesMap(t.data.data.ids)
                        );
                        break;
                      ...
                      case "update-attribute-value":
                        l.updateOriginalAttribute(t.data.attribute),
                          l.afterChange();
                        break;
                      case "add-css-class":
                      ...
                      case "remove-css-class":
                        l.removeCustomCssClass(t.data.className),
                          l.afterChange();
                        break;
                      ...
                      case "remove-custom-attribute":
                        l.removeCustomAttribute(t.data.attributeName),
                          l.afterChange();
                        break;
                      case "save-node":
                        parent.postMessage(
                      ...
                      case "scroll":
                        ...
                        switch (d.deltaMode) {
                          case 0:
                            window.scrollTo(
                              window.scrollX + d.deltaX,
                              window.scrollY + d.deltaY
                            );
                            break;
                          case 1:
                            window.scrollTo(
                              window.scrollX + 15 * d.deltaX,
                              window.scrollY + 15 * d.deltaY
                            );
                            break;
                          case 2:
                            window.scrollTo(
                              window.scrollX + 0.03 * d.deltaX,
                              window.scrollY + 0.03 * d.deltaY
                            );
                        }
                        break;
                      case Qt:
        ...
        parent.postMessage({ action: "dom-load" }, "*"),
        document.addEventListener("keydown", function (t) {
          "Escape" === t.key &&
            parent.postMessage({ action: "escape-clicked" }, "*");
        }),
        document.addEventListener("click", function () {
          parent.postMessage({ action: "document-clicked" }, "*");
        });
    }),
    document.addEventListener("turbo:click", function (t) {
      parent.postMessage({ action: "link-click", data: t.data }, "*");
    }),
    document.addEventListener("turbo:before-visit", function (t) {
      Zt.saveQueryParams(t.detail.url), Zt.updatePageNum();
    }),
    document.addEventListener("turbo:load", function () {
      Zt.injectPreloadLinks(),
        setTimeout(function () {
    ...
    document.addEventListener("turbo:render", function () {
      Zt.styleScrollbar(),
        Zt.showActionLinks(),
        Kt.updateHostposts(),
        parent.postMessage({ action: "turbo-render" }, "*");
    });
})();
