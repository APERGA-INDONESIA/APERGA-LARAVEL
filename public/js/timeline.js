...
(function () {
  ...
  function setup_listener(root_element, listener_specs, event_handler) {
    ...
    if (listener_specs.listener_type === "timer") {
      ...
      ["click", "mouseenter", "mouseleave"].includes(
          ...
          if (from_current_position) {
            ...
            Object.keys(sides_opposites).forEach(function (side) {
              if (full_params.hasOwnProperty(side)) {
                ...
                var _normalize_to_percent =
                    normalize_to_percent_and_offset(value),
    ...
    try {
      var _loop2 = function _loop2() {
        ...
        function on_listener_run() {
          ...
          var element_selector_to_changed_properties =
            timeline_get_changed_properties_between_states(
              initial_properties,
          ...
          Object.entries(listener_specs.animations).forEach(function (_ref13) {
            ...
            if (
              element_selector_to_changed_properties.hasOwnProperty(selector)
            ) {
  ...
  function run_when_doc_ready(fn) {
    if (!document.getElementById("anime-js-script")) {
      ...
      animejs_element.setAttribute(
        "src",
        "https://cdn.jsdelivr.net/npm/animejs@3.1.0/lib/anime.min.js"
      );
      animejs_element.setAttribute(
        "integrity",
        "sha256-98Q574VkbV+PkxXCKSgL6jVq9mrVbS7uCdA+vt0sLS8="
      );
    ...
    if (!document.getElementById("imgloaded-js-script")) {
      ...
      imgloaded_element.setAttribute(
        "src",
  ...
  function timeline_load_initial_values(components) {
    components.forEach(function (component) {
      ...
      Object.values(component.states_flow).forEach(function (state_spec) {
        Object.entries(state_spec.overrides).forEach(function (_ref15) {
          ...
          var element =
            selector === ""
              ? root_element
              : root_element.querySelector(selector);
      ...
      Object.entries(
        component.states_flow[initial_state_name].overrides
  ...
  function autoanim_reorder_by_z_indexes() {
    ...
    var _iterator5 = _createForOfIteratorHelper(
        document.querySelectorAll(".screen[data-screens] *")
      ),
      _step5;
    ...
    try {
      for (_iterator5.s(); !(_step5 = _iterator5.n()).done; ) {
        ...
        if (z !== -1) {
          ...
          var parent_z_values = parents_contained_z_values.get(
            element.parentNode
          );
    ...
    var _iterator6 = _createForOfIteratorHelper(
        parents_contained_z_values.entries()
      ),
      _step6;
  ...
  function autoanim_change_to_screen(
    current_slug,
    target_slug,
    easing,
    duration
    ...
    if (duration) {
      ...
      var all_elements = new Set(
        [].concat(
          _toConsumableArray(new_styles.keys()),
          _toConsumableArray(old_styles.keys())
        )
      );
        ...
        for (_iterator8.s(); !(_step8 = _iterator8.n()).done; ) {
          ...
          try {
            for (_iterator9.s(); !(_step9 = _iterator9.n()).done; ) {
              ...
              var new_value =
                new_element_style === null || new_element_style === void 0
                  ? void 0
                  : new_element_style[prop];
              var old_value =
                old_element_style === null || old_element_style === void 0
                  ? void 0
                  : old_element_style[prop];
          ...
          if (Object.keys(this_element_animated_props).length !== 0) {
            per_element_animated_props.set(
              element,
              this_element_animated_props
            );
          }
        }
      } catch (err) {
    ...
    if (history.pushState && current_slug && push_history) {
      ...
      window.location.replace(
        ("" + window.location).split("#")[0] + last_set_hash
      );
    }
  ...
  function init_timeline_components() {
    run_when_doc_ready(function () {
      var _iterator16 = _createForOfIteratorHelper(
          document.querySelectorAll(".component-wrapper")
        ),
        _step16;
